...
export const left: <E = never, A = never>(e: E) => IOTaskEither<E, A> = flow(E.left, T.of, I.of)

export const right: <E = never, A = never>(a: A) => IOTaskEither<E, A> = flow(E.right, T.of, I.of)
